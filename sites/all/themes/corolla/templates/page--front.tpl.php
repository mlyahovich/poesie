...
<script src="/themes/corolla/js/jtruncate.js"></script>
<script type="text/javascript">
    var blockSystemMain = document.getElementById('block-system-main');
    blockSystemMain.style.display = 'none';

    var lastnews = document.getElementById('block-views-last-news-block-block');
    var p = lastnews.querySelectorAll('p');

    for(var i = 0; i < p.length; i++){
        if(p[i].innerHTML.replace(/\s+/g, '') == '' || p[i].innerHTML == '&nbsp;'){
            p[i].remove();
        }
    }
