...
function corolla_preprocess_html(&$vars) {
    ...
    $fonts = array(
        ...
        'google_font_fira_sans' => 'http://fonts.googleapis.com/css?family=Fira+Sans:300italic&subset=cyrillic,cyrillic-ext,latin',
        'google_font_comfortaa' => 'http://fonts.googleapis.com/css?family=Comfortaa:300&subset=latin,cyrillic,cyrillic-ext',
        'google_font_andika' => 'http://fonts.googleapis.com/css?family=Andika&subset=latin,cyrillic',
        'google_font_bad_script' => 'http://fonts.googleapis.com/css?family=Bad+Script&subset=latin,cyrillic'
...
function corolla_html_head_alter(&$head_elements) {
    $head_elements['chrome_frame'] = array(
        '#type' => 'html_tag',
        '#tag' => 'meta',
        '#attributes' => array('property' => 'fb:admin', 'content' => '100008979220947,100001277653892'),
        '#weight' => -1001,
    );
    ...
    $head_elements['device_width'] = array(
        '#type' => 'html_tag',
        '#tag' => 'meta',
        '#attributes' => array('property' => 'fb:app_id', 'content' => '1620784941529353'),
    );
}